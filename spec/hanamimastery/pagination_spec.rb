...
RSpec.describe Hanamimastery::Pagination do
  it "has a version number" do
    expect(Hanamimastery::Pagination::VERSION).not_to be nil
  end
  ...
  describe '#paginate' do
    ...
    it 'calling reader without setter raises the error' do
      expect { pagination_reader.call }.to raise_error(Hanamimastery::Pagination::PaginationUnsetError)
    end
  end
